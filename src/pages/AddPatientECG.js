...
<Grid container item xs={12} spacing={1} style={{marginTop:"1rem"}}>
  ...
  <Grid item xs={1.5} style={{backgroundColor: '#21D0C3', borderRadius: '9px', cursor: 'pointer',marginRight:"7rem",marginLeft:"1rem"}} 
   ...
   <Grid item xs={1.5} style={{backgroundColor: '#00B8D4',border:'4.5px solid #4C4E37', borderRadius: '9px', cursor: 'pointer',marginRight:"7rem",marginLeft:"1rem"}} 
         >
...
>
  ...
  <Button   variant="contained" onClick={() => {navigate('/dashboard/add-patient-prescription') }}
  style={{ backgroundColor: "#000000"/*"#F97D0B"*/, paddingTop: '10px', paddingBottom: '10px', 
  paddingRight: '30px', paddingLeft: '30px'}}
>
